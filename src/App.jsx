...
export default function App() {
  ...
  useEffect(() => {
    fetch(`https://script.google.com/macros/s/AKfycbxS1_Vp3Xs33FBXxWFaOXNCsOBNrrOU21OtyF44POb8ILMujJ4_04XB-zGxA0rsb7Fv/exec?action=get_menu&_t=${Date.now()}`, { cache: 'no-store' })
      .then(res => res.json())
      .then(data => {
        if (data.success) {
